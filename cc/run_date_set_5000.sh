...
for lr in "${lrs[@]}"; do
    for dropout in "${dropouts[@]}"; do
        ...
        output_file="/home/mila/h/haolun.wu/projects/Disk-SNAKE/exp_out/date-set-order-N_5k_lr${lr}_dropout${dropout}.out"
...
python3 /home/mila/h/haolun.wu/projects/Disk-SNAKE/train.py --dataset=date-set-order-N --num_data=5000 --epochs=5000 --wandb=1 --lr=${lr} --dropout=${dropout}
